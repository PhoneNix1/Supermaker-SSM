...
<%@ page import="cn.itcast.domain.OrderItem" %>
<html>
<head>
...
<script type="text/javascript">
    ...
    // 复选框勾选-再点击删除按钮(如果勾选 商品条码、数量和查询商品不可用)
    // function ChkSonClick(checkInput){
    //     if(checkInput.checked){
    //         document.getElementById("commodity_id_txt").disabled=true;
    //         document.getElementById("commodity_count_txt").disabled=true;
    //         document.getElementById("add_btn").disabled=true;
    //
    //     } else{
    //         document.getElementById("commodity_id_txt").disabled=false;
    //         document.getElementById("commodity_count_txt").disabled=false;
