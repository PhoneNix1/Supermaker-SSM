...
public interface OrderItemMapper {
    ...
    // 将购买的商品插入购物车表中
    @Insert("insert into tb_order_item(id,order_number,commodity_id,commodity_name,price,count,total,is_checked,specification,units,stock) " +
            "values(#{id},#{order_number},#{commodity_id},#{commodity_name},#{price},#{count},#{total},#{isChecked},#{specification},#{units},#{stock})")
